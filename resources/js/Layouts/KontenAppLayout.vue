        ...
        <nav class="bg-gray-800 border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="`/dashboard/konten`">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-4 sm:flex">
                            <jet-nav-link href="/dashboard/konten" :active="$page.currentRouteName == 'admin_dashboard'">
                                Dashboard
                            </jet-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-4 sm:flex">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link href="/dashboard/konten" :active="$page.currentRouteName == 'dashboard'" v-if="$page.auth.user.role == 'user'">
                        Dashboard
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/admin/profil" :active="$page.currentRouteName == 'admin_dashboard'" v-else>
                        Profil Penerima
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/admin/blog" :active="$page.currentRouteName == 'biodata_show'" v-if="$page.auth.user.role == 'user'">
                        Blog
                    </jet-responsive-nav-link>
