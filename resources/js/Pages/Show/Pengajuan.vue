      ...
      <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <laman-section>
          ...
          <template #description>
            ...
            <jet-button>
              <inertia-link  href="/pengajuan/create" :active="$page.currentRouteName == 'biodata_create'">
                Tambah/Ubah Data
              </inertia-link >
            </jet-button>
          </template>
              ...
              <table class="table-auto">
                <div>
                  ...
                  <tr>
                    ...
                    <td class="border px-4 py-2"><a href="data.rab">File RAB</a></td>
                  </tr>
                  <tr>
                    <td class="border px-4 py-2">Video</td>
                    <td class="border px-4 py-2"><a href="data.video" v-if="data.video">Link Video</a></td>
                  </tr>
                </div>
              </table>
            </div>
