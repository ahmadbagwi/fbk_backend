          ...
          <template #laman-admin>
            <tr>
              <td class="p-2">
                  ...
                  class   = ""
                  :data   = "data"
                  worksheet = "administrasi"
                  name    = "administrasi.xls">
              ...
              <td class="p-2">
                <inertia-link :href="'/admin/administrasi'">
            ...
            <vue-good-table
              ...
              <template slot="table-row" slot-scope="props">
                <span v-if="props.column.field == 'surat_permohonan'">
                  <div class="input-group-btn">
                    <button class="flex text-green-400 border-green-400 px-1 py-1 rounded" >
                      ...
                      </svg>&nbsp;<a :href="props.row.permohonan" target="_blank">File</a>
                    </button>
                  </div>
                </span>

                <span v-if="props.column.field == 'proposal_'">
                  <div class="input-group-btn">
                    <button class="flex text-green-400 border-green-400 px-1 py-1 rounded" >
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-up-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path fill-rule="evenodd" d="M5.172 10.828a.5.5 0 0 0 .707 0l4.096-4.096V9.5a.5.5 0 1 0 1 0V5.525a.5.5 0 0 0-.5-.5H6.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>
                      </svg>&nbsp;<a :href="props.row.proposal" target="_blank">File</a>
                    </button>
                  </div>
                </span>

                <span v-if="props.column.field == 'surat_pertanggungjawaban'">
                  <div class="input-group-btn">
                    <button class="flex text-green-400 border-green-400 px-1 py-1 rounded" >
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-up-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path fill-rule="evenodd" d="M5.172 10.828a.5.5 0 0 0 .707 0l4.096-4.096V9.5a.5.5 0 1 0 1 0V5.525a.5.5 0 0 0-.5-.5H6.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>
                      </svg>&nbsp;<a :href="props.row.pertanggungjawaban" target="_blank">File</a>
                    </button>
                  </div>
                </span>

                <span v-if="props.column.field == 'surat_kesanggupan'">
                  <div class="input-group-btn">
                    <button class="flex text-green-400 border-green-400 px-1 py-1 rounded" >
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-up-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path fill-rule="evenodd" d="M5.172 10.828a.5.5 0 0 0 .707 0l4.096-4.096V9.5a.5.5 0 1 0 1 0V5.525a.5.5 0 0 0-.5-.5H6.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>
                      </svg>&nbsp;<a :href="props.row.kesanggupan" target="_blank">File</a>
                    </button>
                  </div>
                </span>
                  ...
                  <div class="input-group-btn">
                    <button class="flex text-green-400 border-green-400 px-1 py-1 rounded" >
                      <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-up-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path fill-rule="evenodd" d="M5.172 10.828a.5.5 0 0 0 .707 0l4.096-4.096V9.5a.5.5 0 1 0 1 0V5.525a.5.5 0 0 0-.5-.5H6.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707z"/>
                      </svg>&nbsp;<a :href="`/admin/administrasi/show/${props.row.id}`" target="_blank">Detail</a>
                    </button>
                  </div>
                </span>
  ...
  export default {
    ...
    data() {
      return {
        ...
        {
          label: 'Surat Pertanggung Jawaban Mutlak',
          field: 'surat_pertanggungjawaban',
        },
        {
          label: 'Surat Kesanggupan',
          field: 'surat_kesanggupan',
        },
        {
          label: 'Status',
          field: 'status',
    ...
    methods: {
      ...
      deleteData(id){
        ...
        this.form.post('/admin/administrasi/delete', {
          preserveScroll: true
        })
      }
    },
